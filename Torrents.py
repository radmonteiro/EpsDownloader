...
def test_tv():
    try:
        TorrentMediaSearcher().request_tv_magnet(provider='eztv', show='big bang theory', season=1, episode=10,
                                                 quality='normal', callback=on_finished)
...
def test_movie():
    try:
        TorrentMediaSearcher().request_movie_magnet(provider='yify', movie='iron man', year=2008, quality='1080p',
